<div class="relative">
    <input
        class="block w-full text-xs border-gray-300 rounded-md shadow-sm sm:pl-9 focus:ring-indigo-500 focus:border-indigo-500"
    ...
    <div class="absolute inset-y-0 left-0 items-center hidden pl-3 pointer-events-none sm:flex">
